          ...
          <div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-shrink-0">
                {isUploading ? (
                  <div className="w-32 h-32 rounded-full bg-[#0f1419] border border-white/[0.06] flex flex-col items-center justify-center gap-2">
                  ...
                  <div className="w-32 h-32 rounded-full bg-[#0f1419] border-2 border-dashed border-white/[0.06] flex items-center justify-center">
